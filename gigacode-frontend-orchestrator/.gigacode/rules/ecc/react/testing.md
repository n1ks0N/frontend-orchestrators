...
- Mocking React hooks (`jest.mock("react", ...)`) — change the component boundary instead
...
Use `.gigacode/skills/ecc-react-testing/SKILL.md` for focused React regression testing rules.
